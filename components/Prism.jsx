  ...
  useEffect(() => {
    ...
    const render = t => {
      ...
      if (animationType === 'hover') {
        ...
        if (Math.abs(yaw-targetYaw)<1e-4 && Math.abs(pitch-targetPitch)<1e-4 && Math.abs(roll)<1e-4) keepGoing=false;
      } else if (animationType === '3drotate') {
        const ts = time * TS;
        ...
        rotBuf[0]=1;rotBuf[1]=0;rotBuf[2]=0;rotBuf[3]=0;rotBuf[4]=1;rotBuf[5]=0;rotBuf[6]=0;rotBuf[7]=0;rotBuf[8]=1;
