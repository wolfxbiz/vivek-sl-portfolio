export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-end px-8 md:px-16 lg:px-24 pb-24 pt-32 bg-black">
      <div className="max-w-5xl">
        <p className="text-white/30 text-xs tracking-[0.3em] uppercase mb-10">
          VIVEK S L — Product-Minded Designer
        </p>
        <h1 className="text-white text-5xl md:text-6xl lg:text-7xl leading-[1.1] tracking-tight mb-8 max-w-4xl">
